...
SECRET_KEY = 'django-insecure-7#wflfll=q-v=z3bp@5@o@)qya=i%o_4!dd(gqgj)r#%00rqe='
...
<<<<<<< HEAD:Simulation/Simulation/settings.py
...
>>>>>>> origin/backend:backend_api/Core/settings.py
]
...
AUTH_PASSWORD_VALIDATORS = [ # fixa validator
    {
...
#AUTHENTICATION_BACKENDS =  'authentication.UserBackend'
>>>>>>> origin/backend:backend_api/Core/settings.py
